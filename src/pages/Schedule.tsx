...
export default class Schedule extends Component<Props, State> {
  ...
  componentDidMount = () => {
    ...
    const response = utilities.getManipulatedData(temp, null);
  ...
  maximizeCalendar = () => {
    var tempObj = { width: 0, height: 0,showButton: true };
  ...
  render() {
    return (
      <div>
        ...
        >
          <div className="col-lg-2" style={paddingCheckBox}>
            <SideCheckBox
              data={appointments}
              callBack={this.callBack}
              attributesObj={this.state.sidebarObj}
            ></SideCheckBox>
          </div>
          <div className="col-lg-10">
            <div className={this.state.showTopBarCalendar ? "" : "hidden"}>
              <TopBarCalender></TopBarCalender>
            </div>
